    ...
    (function() {
            ...
            if (!selector || selector === "#") {
                let hrefAttr =
                    element.getAttribute(
                        "href"); // The only valid content that could double as a selector are IDs or classes,
        ...
        const getTransitionDurationFromElement = element => {
            ...
            const floatTransitionDelay =
                Number.parseFloat(transitionDelay); // Return 0 if element or transition duration is not found
        ...
        const typeCheckConfig = (componentName, config, configTypes) => {
            Object.keys(configTypes).forEach(property => {
                ...
                if (!new RegExp(expectedTypes).test(valueType)) {
                    throw new TypeError(
                        `${componentName.toUpperCase()}: Option "${property}" provided type "${valueType
        ...
        const getNextActiveElement = (list, activeElement, shouldGetNext, isCycleAllowed) => {
            let
                index = list.indexOf(
                    activeElement); // if the element does not exist in the list return an element depending on the direction and if cycle is allowed
        ...
        const EventHandler = {
            ...
            off(element, originalTypeEvent, handler, delegationFn) {
                ...
                const [delegation, originalHandler, typeEvent] =
        ...
        class Collapse extends BaseComponent {
            constructor(element, config) {
                ...
                this._config = this._getConfig(config);
                this._triggerArray = SelectorEngine.find(`${SELECTOR_DATA_TOGGLE$4}[href="#${this._element.id}"],` +
                ...
                for (let i = 0, len = toggleList.length; i < len; i++) {
                    ...
                    const filterElement =
                        SelectorEngine.find(selector).filter(foundElem => foundElem === this._element);
        ...
        function arrow(_ref) {
            ...
            const
                centerToReference =
                    endDiff / 2 -
                        startDiff / 2; // Make sure the arrow doesn't overflow the popper if the center point is
        ...
        function getDocumentRect(element) {
            ...
            const width = max(html.scrollWidth,
                html.clientWidth,
                body ? body.scrollWidth : 0,
                body ? body.clientWidth : 0);
            const height = max(html.scrollHeight,
                html.clientHeight,
        ...
        */
        ...
        function preventOverflow(_ref) {
            ...
            if (checkMainAxis || checkAltAxis) {
                ...
                var arrowPaddingMax =
                    arrowPaddingObject[altSide]; // If the reference length is smaller than the arrow length, we don't want
                ...
                if (checkAltAxis) {
                    ...
                    var _preventedOffset = within(tether ? min(_min, tetherMin) : _min,
                        _offset,
        ...
        class Dropdown extends BaseComponent {
            ...
            show() {
                ...
                if (this._inNavbar) {
                    ...
                    const isDisplayStatic =
                        popperConfig.modifiers.find(modifier => modifier.name === "applyStyles" &&
        ...
        class ScrollBarHelper {
            ...
            hide() {
                ...
                this._setElementAttributes(this._element,
                    "paddingRight",
                    calculatedValue => calculatedValue +
                    width); // trick: We adjust positive paddingRight and negative marginRight to sticky-top elements to keep showing fullwidth
        ...
        class Backdrop {
            ...
            _append() {
                ...
                EventHandler.on(this._getElement(),
                    EVENT_MOUSEDOWN,
                    () => {
            ...
            _triggerBackdropTransition() {
                ...
                const isModalOverflowing =
                    scrollHeight >
                        ...
                        .clientHeight; // return if the following background transition hasn't yet completed
        ...
        const allowedAttribute = (attr, allowedAttributeList) => {
            ...
            const regExp =
                allowedAttributeList.filter(attrRegex => attrRegex instanceof
                    RegExp); // Check if a regular expression validates the attribute.
        ...
        class Tooltip extends BaseComponent {
            ...
            dispose() {
                ...
                EventHandler.off(this._element.closest(`.${CLASS_NAME_MODAL}`),
                    "hide.bs.modal",
            ...
            show() {
                ...
                const customClass = typeof this._config.customClass === "function"
        ...
        class ScrollSpy extends BaseComponent {
            constructor(element, config) {
                ...
                this._config = this._getConfig(config);
                this._selector =
                    `${this._config.target} ${SELECTOR_NAV_LINKS}, ${this._config.target} ${SELECTOR_LIST_ITEMS}, ${
            ...
            _activate(target) {
                ...
                if (link.classList.contains(CLASS_NAME_DROPDOWN_ITEM)) {
                    SelectorEngine.findOne(SELECTOR_DROPDOWN_TOGGLE$1, link.closest(SELECTOR_DROPDOWN$1)).classList
                    ...
                    SelectorEngine.parents(link, SELECTOR_NAV_LIST_GROUP$1).forEach(listGroup => {
                        ...
                        SelectorEngine.prev(listGroup, `${SELECTOR_NAV_LINKS}, ${SELECTOR_LIST_ITEMS}`)
                            .forEach(item => item.classList.add(
                                CLASS_NAME_ACTIVE$1)); // Handle special case when .nav-link is inside .nav-item
                ...
                EventHandler.trigger(this._scrollElement,
                    EVENT_ACTIVATE,
                    {
