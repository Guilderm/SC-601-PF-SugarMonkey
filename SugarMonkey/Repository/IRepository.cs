...
namespace OnlineShopping.Repository
{
    public interface IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        IEnumerable<Tbl_Entity> GetRecordsToShow(int pageNo, int pageSize, int currentPageNo,
        ...
        void InactiveAndDeleteMarkByWhereClause(Expression<Func<Tbl_Entity, bool>> wherePredict,
