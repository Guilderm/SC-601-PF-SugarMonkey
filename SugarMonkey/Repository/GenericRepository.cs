...
namespace OnlineShopping.Repository
{
    ...
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        private readonly DbSet<Tbl_Entity> _dbSet;
        ...
        public IEnumerable<Tbl_Entity> GetRecordsToShow(int pageNo, int pageSize, int currentPageNo,
            Expression<Func<Tbl_Entity, bool>> wherePredict, Expression<Func<Tbl_Entity, int>> orderByPredict)
        {
        ...
        public void UpdateByWhereClause(Expression<Func<Tbl_Entity, bool>> wherePredict,
        ...
        public void InactiveAndDeleteMarkByWhereClause(Expression<Func<Tbl_Entity, bool>> wherePredict,
            Action<Tbl_Entity> ForEachPredict)
        {
            _dbSet.Where(wherePredict).ToList().ForEach(ForEachPredict);
            _DBEntity.SaveChanges();
        ...
        public void DeleteMarkByWhereClause(Expression<Func<Tbl_Entity, bool>> wherePredict,
            Action<Tbl_Entity> ForEachPredict)
        {
            _dbSet.Where(wherePredict).ToList().ForEach(ForEachPredict);
            _DBEntity.SaveChanges();
