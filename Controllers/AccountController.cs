    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult ForgotPassword(ForgotPasswordViewModel fpm)
        {
                ...
                i.EmailId == fpm.EmailId && i.IsActive == true && i.IsDelete == false) != null)
            {
                ...
                body = body.Replace("_ResetPasswordUrl",
                    ConfigurationManager.AppSettings["ApplicationRootUrl"] + "/Account/ResetPassword?EmailId=" +
                    EncryptDecrypt.Encrypt(fpm.EmailId, true));
